  ...
  <div class="cards-stack fade-in delay-2">
    <div class="premium-card autonomy-card">
      <div class="autonomy-content">
        <div class="autonomy-text">
          <h3 class="card-question">Efficienza Termica</h3>
    ...
    <div class="premium-card market-card">
      <div class="market-header-row">
        <h3 class="card-question">Analisi di Mercato AI</h3>
      ...
      <div class="market-grid">
        <div class="market-mini-item">
          <label>Costo Unitario Rilevato</label>
          <p>{{ marketInfo.unit_cost }} €/Smc</p>
        </div>
        <div class="market-mini-item">
    ...
    <div class="premium-card smart-card-premium">
      <div class="smart-header">
        ...
        <span class="smart-label">LA TUA MOSSA VINCENTE</span>
      </div>
...
.percent-val { font-size: 20px; font-weight: 900; color: #f59e0b; }
.autonomy-mini-bar { width: 100%; height: 4px; background: var(--border-color); border-radius: 4px; overflow: hidden; }
.mini-bar-fill { height: 100%; background: #f59e0b; transition: width 1.5s ease; }
...
.ai-badge-btn { background: rgba(245, 158, 11, 0.1); color: #f59e0b; border: 1px solid #f59e0b; padding: 4px 10px; border-radius: 12px; font-size: 10px; font-weight: 800; cursor: pointer; display: flex; align-items: center; gap: 4px; }
.hover-scale:hover { transform: scale(1.02); }

.market-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
.market-mini-item label { display: block; font-size: 9px; font-weight: 800; color: #f59e0b; margin-bottom: 2px; text-transform: uppercase; }
...
.smart-card-premium { border: 1px solid #f59e0b; }
.smart-header { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; }
.icon-box-small { color: #f59e0b; width: 18px; height: 18px; font-size: 16px; }
.smart-label { font-size: 10px; font-weight: 900; color: #f59e0b; letter-spacing: 1px; }
